...
void real_enc_proj_bwd_v2(
    ...
    for (unsigned int e = e_start_i[i]; e < e_end; e++)
    {
        ...
        #endif
        for (float n1 = -R1, px_avr1=0, pbg_avr1=0, sum_v1=0; n1 <= R1; n1++, px_avr +=px_avr1, pbg_avr +=pbg_avr1, sum_v +=sum_v1, px_avr1=pbg_avr1=sum_v1=0)
        for (float n2 = -R2, px_avr2=0, pbg_avr2=0, sum_v2=0; n2 <= R2; n2++, px_avr1+=px_avr2, pbg_avr1+=pbg_avr2, sum_v1+=sum_v2, px_avr2=pbg_avr2=sum_v2=0)
